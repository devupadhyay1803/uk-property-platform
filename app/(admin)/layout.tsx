...
import { LayoutDashboard, Building2, Users, UsersRound, Mail, Wrench, Menu } from 'lucide-react';
...
const sidebarLinks = [
 ...
 { href: '/admin/landlords', label: 'Landlords', icon: UsersRound },
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
 ...
 <p className="truncate text-sm font-medium text-white">{user.profile.full_name || 'Admin'}</p>
